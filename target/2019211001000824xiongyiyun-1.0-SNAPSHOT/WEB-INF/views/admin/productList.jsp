<%@ page import="com.xiongyiyun.model.Product" %>
<%@ page import="java.sql.Connection" %>
<%@ page import="com.xiongyiyun.model.Category" %>
		...
		<div class="table-responsive col-sm-10">
			...
			<c:forEach var="p" items="${productList}">
				<tr>
					...
					<%
						com.xiongyiyun.model.Product p=(com.xiongyiyun.model.Product)pageContext.findAttribute("p");
