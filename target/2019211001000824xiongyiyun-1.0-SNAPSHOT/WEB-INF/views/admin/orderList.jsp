		...
		<div class="table-responsive col-sm-10">
			<table class="table table-condensed">
				...
				<tr>
					...
					<td>${o.orderDate}</td>
					<%
						com.xiongyiyun.model.Order o=(com.xiongyiyun.model.Order)pageContext.findAttribute("o");
						int userId=o.getCustomerId();
						java.sql.Connection con=(java.sql.Connection)application.getAttribute("con");
						com.xiongyiyun.dao.Userdao userDao=new com.xiongyiyun.dao.Userdao();
					...
					<td class="cart_total">
						<%
							...
							String paymentType=com.xiongyiyun.model.Payment.findByPaymentId(con,n);
						%>
