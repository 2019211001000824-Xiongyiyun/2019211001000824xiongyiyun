...
public class Userdao implements IUserDao{
    ...
    public int updateUser(Connection con, User user) throws SQLException {
        try{
            Statement createDbStatement = con.createStatement();
            String dbRequire="update usertable set username='"+user.getUsername()+"',password='"+user.getPassword()+"',mail='"+user.getEmail()+"',sex='"+user.getGender()+"',date='"+user.getBirth()+"' where id="+user.getId();
            createDbStatement.executeUpdate(dbRequire);
